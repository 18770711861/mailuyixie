...
<article>
<header>
	<h1>小福 <span>smallhuhu</span></h1>
	<ul>
		<li><a href="https://coolyuanfu.github.io">个人博客</a></li>
		<li><a href="http://cnblogs/yuanfu">博客园</a></li>
		<li><a href="https://github.com/coolyuanfu">Github</a></li>
	</ul>
</header>

<section id="summary">
	<h1>Summary</h1>
	<p>我是一个半路出家的前端，之前从事高(ku)大(bi)上的Java。工作中发现自己喜欢的其实是前端，于是去年6月份(2016)开始从《dive into html》和 hello world 开始看起，大概有半年时间，处于一种痛苦，焦虑，快乐交织在一起的状态。现在在一家创业公司做前端。
	</p>
</section>
...
<section id="work-experience">
	...
	<ol class="timeline">
		<li>
			...
			<p>中国信息通信研究院</a></p>
			<p class="note">从事咨询，通信研究，由于现场跑的比较多，get到了吃苦耐劳的精神</p>
		</li>
		<li>
			<p class="date">2017.3-2017.10</p>
			<p>＊＊＊</a></p>
			<p class="note">＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊<a href='https://github.com/imgss/table'>jQuery-table</a></p>
		</li>
	</ol>
</section>
...
article {
	...
	font: 100%/1.6 'Segoe UI', Optima, 'Hiragino Kaku Gothic Pro', 'Apple Gothic', Tahoma, 'Helvetica Neue', sans-serif;
...
section > h1 {
	box-shadow: calc(-8vw + .6em) 0 white, calc(-8vw - .1em) 0 0 -.1em;
}
...
@media print {
	...
	section > h1 {
		box-shadow: calc(-8vw + 2em) 0 white, calc(-8vw - .1em) 0 0 -.1em;
	}
